...
module.exports = {
    ...
    theme: {
        extend: {
            ...
            fontWeight: {
                thin: tokens.fontWeight['weight-thin'],
                extralight: tokens.fontWeight['weight-extralight'],
                light: tokens.fontWeight['weight-light'],
                normal: tokens.fontWeight['weight-normal'],
                medium: tokens.fontWeight['weight-medium'],
                semibold: tokens.fontWeight['weight-semibold'],
                bold: tokens.fontWeight['weight-bold'],
                extrabold: tokens.fontWeight['weight-extrabold'],
                black: tokens.fontWeight['weight-black'],
            },
            opacity: {
